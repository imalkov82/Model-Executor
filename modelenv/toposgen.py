...
def main(bin_loc, genv_flag, cyn_flag, disp_path):
    ...
    for _ , s in wrk_data.iterrows():
        ...
        dir_surfs = [zs_func(s['step{0}'.format(j)] * np.sin(np.deg2rad(60)), gen_mgsurf) for j in range(3)]
...
if __name__ == '__main__':
    ...
    main(kvargs.bin_path_arg, kvargs.gen_env, kvargs.cyn_flag, kvargs.disp_path)